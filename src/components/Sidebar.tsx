...
const Sidebar: React.FC<SidebarProps> = ({ currentTab, setTab, isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    ...
    { id: 'buses', label: 'Ônibus', icon: BusIcon, roles: [UserRole.ADMIN], color: 'text-blue-600', bg: 'bg-blue-50' },
    ...
    { id: 'manifest', label: 'Lista de Chamada', icon: ClipboardList, roles: [UserRole.ADMIN, UserRole.COORDINATOR], color: 'text-amber-600', bg: 'bg-amber-50' },
